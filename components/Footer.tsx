    ...
    <footer className="bg-white border-t border-slate-200 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              />
              <span className="text-lg font-bold text-slate-900">Glyph</span>
            </Link>
          ...
          <div>
            <h4 className="font-bold text-slate-900 mb-6">Organize</h4>
            <ul className="space-y-4">
              ...
              <li><Link href="/tools/organize" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">Organize Pages</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold text-slate-900 mb-6">Convert</h4>
            <ul className="space-y-4">
              <li><Link href="/tools/html-to-pdf" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">HTML to PDF</Link></li>
              <li><Link href="/tools/images-to-pdf" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">PDF to Images</Link></li>
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 text-center">
          ...
          <p className="text-base sm:text-lg font-semibold text-slate-500">
            Made with ❤️ by <a href="https://abhiraj.dev" target="_blank" rel="noopener noreferrer" className="underline decoration-dotted underline-offset-4 decoration-2 decoration-slate-300 hover:text-blue-600 hover:decoration-blue-600 transition-all">Abhiraj</a>
          </p>
        </div>
      </div>
    </footer>
